...
class Proximolancamento extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    fetch(process.env.REACT_APP_API_URL_PL)
      .then(res => res.json())
      .then((data) => {
  ...
  render() {
    return (
      <React.Fragment>
        <Header {...Proximolancamento} />
        <Main icon="rocket" title="Próximo Lançamento" className="container">
                ...
                <ul>
                  ...
                  <ul>
                    ...
                    <ul>
                      ...
                      <span className="text-secundary">fairings:</span>
...
export default Proximolancamento;